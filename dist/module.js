(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("xmldom"), require("angular"));
	else if(typeof define === 'function' && define.amd)
		define(["xmldom", "angular"], factory);
	else if(typeof exports === 'object')
		exports["angular-jxon"] = factory(require("xmldom"), require("angular"));
	else
		root["angular-jxon"] = factory(root["xmldom"], root["angular"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	if (typeof window.DOMParser === 'undefined') {
	  window.DOMParser = __webpack_require__(1).DOMParser;
	  window.document = {};
	  window.document.implementation = new (__webpack_require__(1).DOMImplementation)();
	}
	/**
	* @class EmptyTree
	*/
	...
	var JXONService = (function () {
	  ...
	  */
	  ...
	  _createClass(JXONService, [{
	    ...
	    */
	    value: function xmlToString(xmlObj) {
	      if (typeof xmlObj.xml !== 'undefined') {
	        ...
	        if (typeof window.XMLSerializer === 'undefined') window.XMLSerializer = __webpack_require__(1).XMLSerializer;
	    ...
	    * @alias jsToXml
	    */
	    value: function unbuild(oObjTree, sNamespaceURI, /* optional */sQualifiedName, /* optional */oDocumentType /* optional */) {
	...
	* @name angular-jxon
	*/
	var Module = __webpack_require__(2).module('angular-jxon', ['ng']);
	/**
	* @ngdoc provider
	* @name $JXONProvider
